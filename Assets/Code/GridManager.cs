...
public class GridManager : MonoBehaviour
{
    ...
    private int [,] firstLevelGrid = new int[,] {
        ...
        {2,7,0,0,2,8,2,1,9,0,0,0,0,2,0,0,2},
        {2,0,0,0,2,2,2,0,2,2,2,0,7,2,0,0,2},
        {2,0,7,0,9,0,0,0,0,0,2,0,0,2,0,7,2},
        {2,0,0,0,2,0,0,0,0,0,2,0,0,2,0,0,2},
        {2,3,2,2,2,0,0,7,0,0,2,2,3,2,2,3,2},
        {2,0,7,0,3,0,0,0,0,0,3,0,0,0,0,0,2},
        {2,3,2,2,2,0,0,7,0,0,2,2,2,3,2,2,2},
        {2,0,0,0,2,0,0,0,0,0,2,0,0,0,0,0,2},
        {2,0,7,0,2,0,0,0,0,0,2,0,0,7,0,0,2},
        {2,0,0,0,2,3,2,2,2,3,2,0,0,0,0,7,2},
        {2,0,0,0,2,0,2,8,2,0,9,0,0,7,0,0,2},
        {2,2,2,2,2,0,2,8,2,0,2,2,2,2,2,2,2},
        {2,0,0,0,0,0,2,8,2,0,9,0,7,0,7,0,2},
        {2,0,2,2,2,2,2,8,2,0,2,0,0,0,0,0,6},
        {2,0,2,8,8,8,8,8,2,3,2,0,0,0,0,0,2},
        {2,0,2,8,8,8,8,8,2,0,0,0,0,0,0,0,2},
        {2,3,2,2,2,2,2,2,2,0,0,7,0,0,7,0,2},
        {2,0,0,0,0,0,7,0,2,0,0,0,0,0,0,0,2},
        {9,0,0,0,7,0,0,0,2,0,0,7,0,0,0,0,2},
        {2,7,0,0,0,7,0,0,9,0,0,0,0,0,0,0,2},
    ...
    IEnumerator DelayedMoveMonsters(Vector3 partyPosition) {
        foreach (GameObject monster in monsters) {
            ...
            monster.GetComponent<MonsterController>().ReportPartyDidMove(partyPosition);
        }
    }
